...
<body>
    ...
    <div class="search" >
        ...
        <div class="cirpic">
            <img class="small border" src="77.jpg" width="400px">
            <img class="small border" src="72.jpg" width="400px" >
            <img class="small border" src="71.jpg" width="400px">
            <img class="small border" src="73.jpg" width="400px" >
            <img class="small border" src="74.jpg" width="400px">
            <img class="small border" src="75.jpg" width="400px" >
            <img class="small border" src="76.jpg" width="400px">
        </div>
        <div class ="text">
            <table cellpadding="87">
                <tr div class="head">
                    <th>JESPIAH SHIHANA</th>
                    <th>SULOCHANA BAI</th>
                    <th>PAUL SUDHAKAR</th>
                    <th>SONIAH</th>
                    <th>AKSIAH SHIBANA</th>
                    <th>ASHLYN SANYA</th>
                    <th>JOHN WESLY</th>
                </tr>
            </table>
        ...
        <footer>
             <p>Designed and Developed by JESPIAH SHIHANA &copy; 2023</p>
      </footer>
...
## OUTPUT:
![Alt text](companyhome.png)
![output](./companypeople.png)
![output](./companyservices.png)
![output](./companycontact.png)
